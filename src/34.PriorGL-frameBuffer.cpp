...
int main()
{
    constexpr const char *const p = __FILE__;
    glfwInit();
    ...
    // create a texture buffer for framebuffer
    GLuint texColorBuffer;
    // if there is not a glActiveTexture(GL_TEXTURE2); before call glBindTexture(GL_TEXTURE_2D,0);
    // then the GL_TEXTURE0 position would be overbing by this texColorBuffer
    ...
    // attach framebuffer-texture to framebuffer
    ...
    // create depth && stencil render buffer object
