...
struct CROP : public I_Render_Task
{
    ...
    void ShowConfig() override
    {
        ...
        {
           params->frame_height.data= params->shader_params->overlay_Height.data = params->shader_params->dst_Height.data = params->frame_height.data = tex.height;
            params->frame_width.data= params->shader_params->overlay_Width.data = params->shader_params->dst_Width.data = params->frame_width.data = tex.width;
        }
    }
